    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
                    ...
                    @auth
                      {{-- Los siguientes link los quito para administralos yo --}}
                       <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Dashboard</a> 
                        ...
                        <a href="{{ route('home') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Control de acceso</a>
            ...
            <div><h1 style="font-size: 50px; color: tomato;">BIENVENIDOS A: </h1>
                <br>
               <h1 style="font-size: 100px; color: tomato;"><br>BASALCONTROL</h1>
           </div>    
