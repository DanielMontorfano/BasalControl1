        ...
        <div class="container d-flex justify-content-center" style="height: 55vh;">
            <div class="card backCard" style="width: 400px; margin-top: auto; margin-bottom: auto;">
                <div class="card-body text-center">
                    ...
                    <p class="card-text"><h4>¿Está persona está saliendo con vehiculo y sin materiales?</h4></p>
                   
                    <img src="{{ asset('iconos/CamionLindo2.png') }}" alt="Imagen" style="width: 200px; height: auto; margin-bottom: 20px;">
